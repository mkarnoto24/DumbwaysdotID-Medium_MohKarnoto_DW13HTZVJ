...
import iconmission from './../assets/icon_mission.jpeg';
import gbrartikelMission from './../assets/gbrartikel_mission1.jpeg';
                    ...
                    <Grid item xs={7} style={{ margin: '0 auto', paddingTop: '40px' }}>
                        <div style={{ width: '80%' }}>
                            ...
                            <div>
                                ...
                                ></Avatar>
                                <p>Ryan Holiday <Button size="small" variant="outlined" color="primary">Upgrade</Button><br></br><span style={{ fontSize: '12px' }}>Jun 23 2018. 6 min read</span>
                                    <span style={{ float: 'right', alignContent: 'center', marginBottom: '20px' }}>
                                        <TwitterIcon></TwitterIcon>
                                        <FacebookIcon style={{ margin: '0 15px' }}></FacebookIcon>
