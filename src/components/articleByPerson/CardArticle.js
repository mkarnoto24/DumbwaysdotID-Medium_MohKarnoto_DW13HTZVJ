...
export const articleperson = [
    {
        src: 'https://cdn-images-1.medium.com/fit/c/100/100/1*36m2m4xEvnl9-Y9phpHTGQ.jpeg',
        nama: 'Ryan Holiday',
...
function CardArticlePerson(props) {
    ...
    return (
        <div style={{ marginTop: 30 }}>
            <div><Typography variant="h6" style={{ paddingBottom: '20px' }}>Feature</Typography></div>
            <Card>
                <CardContent >
                    ...
                    <div style={{ padding: "20px 10px 20px 0" }}>
                        <CardMedia
                            component="img"
                            src="https://cdn-images-1.medium.com/focal/800/240/50/67/1*bLVCKLmbPOHFzZDQV3ihgA.jpeg"
                        />
